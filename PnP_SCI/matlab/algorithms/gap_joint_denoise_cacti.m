function [v_,psnr_,ssim_,t_,psnrall] = gap_joint_denoise_cacti(mask,meas,orig,v0,para)
%GAP_JOINT_DENOISE_CACTI GAP-joint-Denoise frame for recontruction of  CACTI high-speed 
%imaging.
%   See also gap_joint_denoise.
