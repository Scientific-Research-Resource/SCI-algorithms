...
def cli_run(script_name, orig_name, scale, Cr, mask_name, test_algo_flag,
            ...
            gaussian_noise_level=0, poisson_noise=False, gamma=0,
    ...
    command_str = ('python {} \
        ...
        '--sigma2 ' + (' {:.4f} '*len(sigma2))).format(script_name, orig_name, scale, Cr, mask_name, test_algo_flag,  result_path, iframe, nframe, MAXB,
